...
export const metadata = {
  ...
  description: "Termini di Utilizzo â€” Strumento di Simulazione Fiscale",
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10 border-b border-zinc-200 pb-6">
          <p className="text-xs uppercase tracking-editorial font-semibold text-zinc-400 mb-2">
            Termini di Utilizzo â€” bur0.click
          </p>
        ...
        <div className="space-y-8">
          ...
          <section className="border-b border-zinc-100 pb-8">
            ...
            <h2 className="text-xl font-black text-zinc-950 mb-3">Scopo del Servizio</h2>
            <p className="text-sm text-zinc-600 leading-relaxed">
              <strong className="text-zinc-900">Bur0</strong> &egrave; uno
              strumento di <strong className="text-zinc-900">simulazione e stima</strong>{" "}
          ...
          <section className="border-b border-zinc-100 pb-8">
            ...
            <h2 className="text-xl font-black text-zinc-950 mb-3">Limitazione di Responsabilit&agrave;</h2>
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex gap-3">
                  <span className="text-zinc-300 font-mono font-black flex-shrink-0 pt-0.5">&mdash;</span>
          ...
          <section className="border-b border-zinc-100 pb-8">
            ...
            <h2 className="text-xl font-black text-zinc-950 mb-3">Accuratezza dei Calcoli</h2>
            <p className="text-sm text-zinc-600 leading-relaxed mb-3">
              ...
              e le addizionali regionali/comunali variano per comune.
              Ci impegniamo a mantenere lo strumento aggiornato ma non
              garantiamo la correttezza assoluta dei risultati.
            </p>
          </section>
          ...
          <section className="border-b border-zinc-100 pb-8">
            ...
            <h2 className="text-xl font-black text-zinc-950 mb-3">Modifiche al Servizio</h2>
            <p className="text-sm text-zinc-600 leading-relaxed">
              Ci riserviamo il diritto di modificare, aggiornare o interrompere
              il servizio in qualsiasi momento senza preavviso. Gli algoritmi
              di calcolo possono essere modificati per riflettere aggiornamenti
              normativi.
            </p>
          </section>
          ...
          <section className="border-b border-zinc-100 pb-8">
            ...
            <h2 className="text-xl font-black text-zinc-950 mb-3">Propriet&agrave; Intellettuale</h2>
            <p className="text-sm text-zinc-600 leading-relaxed">
          ...
          <section className="border-b border-zinc-100 pb-8">
            ...
            <h2 className="text-xl font-black text-zinc-950 mb-3">Uso Accettabile</h2>
            <p className="text-sm text-zinc-600 leading-relaxed mb-3">
              L&apos;utente si impegna a utilizzare Bur0 in modo lecito. &Egrave;
              vietato tentare di violare la sicurezza del sito, effettuare
              reverse-engineering del codice o utilizzare il servizio per
              scopi illegali.
            </p>
          </section>
          ...
          <section className="pb-8">
            <p className="text-xs uppercase tracking-editorial font-semibold text-zinc-400 mb-3">07</p>
            <h2 className="text-xl font-black text-zinc-950 mb-3">Legge Applicabile</h2>
            <p className="text-sm text-zinc-600 leading-relaxed">
        ...
        <div className="mt-8 pt-6 border-t border-zinc-200 flex items-center justify-between gap-4">
          <p className="text-xs text-zinc-400">
            Ultima revisione: Marzo 2026 &mdash; Utilizzando Bur0 accetti questi Termini.
          </p>
          <Link
            href="/"

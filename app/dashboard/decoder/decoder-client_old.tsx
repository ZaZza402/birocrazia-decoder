        ...
        <div className="grid grid-cols-3 gap-2">
          {personas.map((p) => {
            ...
            return (
              ...
              >
                {isLocked && (
                  <div className="absolute inset-0 flex items-center justify-center bg-slate-100/50 backdrop-blur-[1px] z-10">
                    <div className="bg-slate-900 text-white text-[10px] font-black px-2 py-1 rounded uppercase">
                      Lucchetto
                    </div>
                  </div>
                )}

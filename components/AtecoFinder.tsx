...
function EntryRow({
  ...
  return (
    ...
    >
      <span className="text-[10px] font-mono font-bold flex-shrink-0 w-[4.5rem] text-zinc-600">
        {entry.code}
      </span>
      ...
      >
        ...
        <div className="px-5 pb-6 pt-2 max-h-[85vh] overflow-y-auto">
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <button
              onClick={onClose}
              className="p-1 text-zinc-500 hover:text-zinc-500 mt-1"
            >
              <X className="w-5 h-5" />
            </button>
          </div>

          <p className="text-sm text-zinc-500 leading-snug mb-0.5">
            {entry.description}
          </p>
          ...
          <Link
            ...
            onClick={onClose}
            className="mt-3 flex items-center justify-center gap-1 text-xs font-bold uppercase tracking-editorial text-zinc-500 hover:text-zinc-500 transition-colors"
          >
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 border-b border-zinc-200 pb-5">
          ...
          <div className="flex items-center gap-1.5 mb-3">
            <Link
              href="/"
              className="text-[10px] uppercase tracking-editorial font-semibold text-zinc-600 hover:text-zinc-700 transition-colors"
            >
              BurZero
            </Link>
          ...
          <p className="mt-1 text-[11px] text-zinc-600 max-w-xl">
          ...
          <div className="lg:col-span-7 space-y-3">
            ...
            <div className="bg-white border border-zinc-200 flex items-center gap-3 px-4 py-3">
              ...
              <input
                ...
                className="flex-1 text-sm text-zinc-950 placeholder:text-zinc-600 outline-none bg-transparent"
                autoFocus
              />
              {query && (
                <button
                  onClick={clearSearch}
                  className="flex-shrink-0 text-zinc-600 hover:text-zinc-700"
                >
                  <X className="w-4 h-4" />
                </button>
              )}
            ...
            <div className="bg-white border border-zinc-200 overflow-hidden">
              ...
              <div className="flex items-center gap-3 px-4 py-2 border-b border-zinc-100 bg-zinc-50">
                <span className="text-[10px] uppercase tracking-editorial font-semibold text-zinc-600 w-[4.5rem] flex-shrink-0">
                  Codice
                </span>
                <span className="text-[10px] uppercase tracking-editorial font-semibold text-zinc-600 flex-1">
                  Attività
                </span>
                <span className="text-[10px] uppercase tracking-editorial font-semibold text-zinc-600 flex-shrink-0">
                  Coeff.
                </span>
              </div>
              ...
              <div className="border-t border-zinc-100 px-4 py-2 flex items-center justify-between">
                ...
                <a
                  ...
                  className="text-[10px] text-zinc-600 hover:text-zinc-700 inline-flex items-center gap-1 transition-colors"
                >
              ...
              <>
                ...
                {selected.tags.length > 0 && (
                  <div className="bg-white border border-zinc-200 p-4">
                    <p className="text-[10px] uppercase tracking-editorial font-semibold text-zinc-600 mb-2.5">
                      Attività correlate
                    </p>
                ...
                <div className="space-y-5">
                  {[
                    ...
                    <div key={step} className="flex items-start gap-3">
                      <span className="text-xs font-mono font-black text-zinc-500 flex-shrink-0 pt-0.5 w-6">
                        {step}
                      </span>

...
- ✅ `STRIPE_SECRET_KEY` - Your Stripe secret key (starts with sk*live*)
- ✅ `NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY` - Your Stripe publishable key (starts with pk*live*)
- ✅ `STRIPE_WEBHOOK_SECRET` - From Stripe webhook endpoint (starts with whsec\_)

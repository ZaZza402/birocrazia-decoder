...
export const metadata: Metadata = {
  title: `Registro Incassi Forfettario ${TAX_YEAR} - Logga ogni pagamento | Bur0`,
  ...
  openGraph: {
    title: `Registro Incassi Forfettario ${TAX_YEAR} | Bur0`,
    description:
...
export default function GiornaleLayout({
  ...
  const schema = {
    ...
    name: "Registro Incassi Forfettario Bur0",

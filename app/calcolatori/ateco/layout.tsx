...
export const metadata: Metadata = {
  title: `Trova il tuo Codice ATECO ${ATECO_RULESET_YEAR} - Ricerca per Attività | BurZero`,
  ...
  openGraph: {
    title: `Trova il tuo Codice ATECO ${ATECO_RULESET_YEAR} | BurZero`,
...
export default function AtecoLayout({
  ...
  const schema = {
    ...
    "@type": "WebApplication",
    name: `Trova Codice ATECO ${ATECO_RULESET_YEAR} - BurZero`,

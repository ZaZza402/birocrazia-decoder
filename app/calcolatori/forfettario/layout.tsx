...
export const metadata: Metadata = {
  ...
  keywords:
    "simulatore regime forfettario, calcolo tasse partita iva 2026, forfettario vs ordinario, tax cliff 100k, calcolo netto freelance, regime forfettario conviene, aliquota forfettario 2026, partita iva simulatore",
  alternates: {

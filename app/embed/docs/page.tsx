  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      <h1 className="text-4xl font-bold mb-8">
        Embed del Calcolatore Forfettario
      </h1>
...
></iframe>`}
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
            <p className="text-sm text-blue-800">
              <strong>Raccomandazioni:</strong> Altezza consigliata 1200px.
              Adatta secondo il tuo layout.
            </p>
          </div>
        </section>
...
></iframe>`}
          ...
          <div className="bg-purple-50 border-l-4 border-purple-500 p-4">
            <p className="text-sm text-purple-800">
              <strong>Nota:</strong> Altezza leggermente maggiore (1250px) per
              includere il footer di branding.
            </p>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-6 border border-indigo-200">
          ...
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold">✓</span>
              <span>
                <strong>Performance:</strong> Il calcolatore è ottimizzato e
                carica in meno di 1.5 secondi
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold">✓</span>
              <span>
                <strong>Privacy:</strong> Nessun dato utente viene raccolto o
